...
const Contact = () => {
    return (
        <div className=" max-w-6xl mx-auto my-12 px-4">
            ...
            <p className="font-semibold mt-5 flex gap-x-3 items-center text-[#6c757d]"><MdEmail className="text-gray-300"></MdEmail>ahteshamsajid8@gmail.com</p>
            <p className="font-semibold mt-5 flex gap-x-3 items-center text-[#6c757d]"><FaPhoneAlt className="text-gray-300"></FaPhoneAlt>+880 1925769550</p>
